										...
										<input type="hidden" name="num" value="${course.num }"/>
											<div class="form-group">
												<label for="exampleInputEmail1">강좌명</label> <input
													type="text" class="form-control" name="name" value="${course.name }">
											</div>

											<div class="form-group">
												<label for="exampleInputEmail1">강좌 가격</label> <input
													type="text" class="form-control" name="price" value="${course.price }">
											</div>
											...
											<div class="form-group">
												...
												<textarea class="textarea" name="detail"
														style="width: 100%; height: 800px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 20px;">${course.detail}</textarea>
