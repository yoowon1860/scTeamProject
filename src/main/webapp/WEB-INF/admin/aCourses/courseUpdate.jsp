              ...
              <div class="mb-3">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="강좌명을 입력하세요">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">강좌 가격</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="가격을 입력하세요">
                  </div>
