        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">강좌명</label>
                    <input type="email" class="form-control" name="name" value="${course.name }">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">강좌 가격</label>
                    <input type="email" class="form-control" name="price" value="${course.price }">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">YouTube Link</label>
                    <input type="email" class="form-control" name="youtube" 
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">썸네일 추가</label>
             ...
             <textarea class="textarea" name="detail" value="${course.detail }"
