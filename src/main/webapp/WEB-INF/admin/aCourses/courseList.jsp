        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div style="text-align:right;"><a style="color:white" class="btn btn-warning btn-sm" href="courseInsert.mdo">강의 추가하기</a></div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <c:forEach var="course" items="${courseList}" varStatus="status">
                  ...
                  <td>
	                  <div style="text-align:center;">
	                  	...
	                  	<a style="color:white" class="btn btn-primary btn-sm" href="courseUpdate.mdo?num=${course.num}">수정</a>
