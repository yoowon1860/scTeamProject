          ...
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
  				...
  				<form role="form" action="courseInsert.mdo" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label >강좌명</label>
                    <input type="text" class="form-control" name="name" placeholder="강좌명을 입력하세요">
                  </div>
             ...
             <textarea class="textarea" name="detail" placeholder="Place some text here"
