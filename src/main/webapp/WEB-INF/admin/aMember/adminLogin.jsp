		...
		<div class="container">
				...
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<a class="button button-account" href="register.mdo">관리자 회원가입</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Log In</h3>
						<form class="row login_form" action="loginCheck.mdo" method="post" id="contactForm" >
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="user-id" name="id" placeholder = '아이디를 입력해주세요.'>
							</div>
							<div class="col-md-12 form-group">
