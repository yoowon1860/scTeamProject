    ...
    <section class="content">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" value="tmddms06@gmail.com">

              </div>
              <div class="form-group">
                <label for="inputDescription">이름</label>
                                <input type="text" id="inputName" class="form-control" value="정승은">
              </div>

              <div class="form-group">
                <label for="inputClientCompany">전화번호</label>
                <input type="text" id="inputClientCompany" class="form-control" value="01092604763">
              </div>
      ...
      <div class="row" style = "text-align: center;">
         <div class="col-12">
          ...
          <a style="color:white" class="btn btn-danger btn-sm">탈퇴</a>
