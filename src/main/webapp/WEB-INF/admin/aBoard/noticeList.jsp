        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <button id="write" style="float:right; background:lightblue;" href="boardWrite.do">
              작 성
    </button>
            </div>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover" style="text-align:center;">
                ...
                <td>${board.regDate }</td>
                <td>${board.viewCnt }</td>
                <td><button style="background:lightblue;" href="">삭제</button> <button style="background:red;" href="boardWrite.jsp?num=${board.num }">수정</button></td>
                </tr>
                </c:forEach>
                </tbody>
