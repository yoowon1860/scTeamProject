...
<%@page import="com.sc.speedcampus.user.study.dao.StudyDAO"%>
<%@page import="com.sc.speedcampus.user.study.vo.StudyVO"%>
...
<head>
 ...
 <script>
	...
	function selChange() {
		...
		location.href="studyList.do?nowPage=${paging.nowPage}&cntPerPage="+sel;
	}
			...
			<nav class="blog-pagination justify-content-center d-flex">
				<ul class="pagination">
					...
					<c:if test="${paging.startPage != 1 }">
						<a href="studyList.do?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}" class="page-link" aria-label="Previous"> 
					...
					<c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
						<c:choose>
							...
							<c:when test="${p != paging.nowPage }">
									<li class="page-item"><a href="studyList.do?nowPage=${p }&cntPerPage=${paging.cntPerPage}" class="page-link">${p }</a></li>
							</c:when>
						</c:choose>
					</c:forEach>
							<c:if test="${paging.endPage != paging.lastPage}">
						<a href="studyList.do?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}" class="page-link" aria-label="Next"> 
							<span aria-hidden="true">
