            ...
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  ...
                  <p data-aos="fade-up" data-aos-delay="100">4 Lessons / 12 Week  2,193 students  <a href="#" class="text-white">6 comments</a></p>
                </div>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
			  ...
			  <p>3강 : ㅇㅇㅇ 두번째 실습</p>
			  <p>4강 : ㅇㅇㅇ 이론 심화편</p>
			  <p>5강 : ㅇㅇㅇ 이론 마무리 및 마지막 실습</p>
			  
              <p class="mt-4"><a href="#" class="btn btn-primary">지금구매</a>
                <a href="#" class="btn btn-primary">구매후기 보기</a></p>
            </div>

<!-- Comments Div Start -->
<!--             <div class="pt-3">
              <h3 class="mb-5">수강 후기</h3>
              <ul class="comment-list">
                <li class="comment">

                  <div class="comment-body">
          1st comment          <h3>Jean Doe</h3>
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    ...
                    <div class="meta">시간</div>
                                            <p>내용</p>
                    <p><a href="#" class="reply">답글 달기</a></p>
                  </div>
